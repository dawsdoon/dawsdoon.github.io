...
function recalculate() {
    let costLabel = document.getElementById("calculated-cost");
    let costPerDay = (modelName === 'Model XYZ') ? 100 : 213;
...
function changeDuration() {
    ...
    let newDuration = prompt("Enter the duration in days:", duration);
    duration = parseInt(newDuration, 10) || duration; 
